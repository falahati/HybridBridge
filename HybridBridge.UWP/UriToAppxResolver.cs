...
namespace HybridBridge.UWP
{
    /// <summary>
    ///     A simple implementation of <see cref="IUriToStreamResolver" /> interface
    ///     that search for files in <c>ms-appx</c> directory
    /// </summary>
    public class UriToAppxResolver : IUriToStreamResolver
    {
        /// <summary>
        ...
        private async Task<IInputStream> GetContent(string path)
        {
            ...
            try
            {
                var localUri = new Uri(@"ms-appx://" + path);
